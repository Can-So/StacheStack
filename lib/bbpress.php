...
function stachestack_bbp_forum_class( $classes ) {
	$classes[] = 'row';
	$classes[] = 'list-unstyled';

	return $classes;
}
add_filter('bbp_get_forum_class', 'stachestack_bbp_forum_class');

function stachestack_bbp_topic_class( $classes ) {
	$classes[] = 'row';
	$classes[] = 'list-unstyled';
	$classes[] = stachestack_bbps_get_topic_status();

	return $classes;
}
add_filter('bbp_get_topic_class', 'stachestack_bbp_topic_class');

function stachestack_bbp_reply_class( $classes ) {
	$classes[] = 'row';
	$classes[] = 'list-unstyled';

	return $classes;
}
add_filter('bbp_get_reply_class', 'stachestack_bbp_reply_class');

function stachestack_bbp_styles() { ?>
	<style type="text/css">
...
add_action( 'wp_head', 'stachestack_bbp_styles' );
 ...
 */
function stachestack_bbp_form_topic_type_dropdown( $args = '' ) {
	echo stachestack_bbp_get_form_topic_type_dropdown( $args );
}
	/**
 ...
 */
function stachestack_bbp_form_topic_status_dropdown( $args = '' ) {
	echo stachestack_bbp_get_form_topic_status_dropdown( $args );
}
	/**
 ...
 */
function stachestack_bbp_user_subscribe_link( $args = '', $user_id = 0, $wrap = true ) {
	echo stachestack_bbp_get_user_subscribe_link( $args, $user_id, $wrap );
}
	/**
 ...
 */
function stachestack_bbp_user_favorites_link( $args = array(), $user_id = 0, $wrap = true ) {
	echo stachestack_bbp_get_user_favorites_link( $args, $user_id, $wrap );
}
	/**
	 * User favorites link
	 *
...
add_action('bbp_template_before_single_topic', 'stachestack_bbps_add_support_forum_features');
		...
		<div id ="bbps_support_forum_move">
			<form id="bbps-topic-move" class="form-horizontal" role="form" name="bbps_support_topic_move" action="" method="post">
				<div class="form-group">
					<label for="bbp_forum_id" class="control-label">Move topic to: </label><?php stachestack_bbp_dropdown(); ?>
 ...
 */
function stachestack_bbp_dropdown( $args = '' ) {
	echo stachestack_bbp_get_dropdown( $args );
}
	/**
