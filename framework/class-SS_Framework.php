	...
	*/
	class SS_Framework {
		...
		function __construct() {
			...
			do_action( 'stachestack_include_frameworks' );
			...
			if ( $compiler ) {
				...
				if ( $compiler == 'less_php' ) {
					...
					require_once 'compilers/less-php/class-StacheStack_Less_php.php';
					$compiler_init = new StacheStack_Less_PHP();

				} elseif ( $compiler == 'sass_php' ) {

					require_once 'compilers/sass-php/class-StacheStack_Sass_php.php';
					$compiler_init = new StacheStack_Sass_PHP();
