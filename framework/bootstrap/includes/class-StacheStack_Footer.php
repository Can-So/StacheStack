...
if( ! class_exists( 'StacheStack_Footer' ) ) {
	/**
	* Build the StacheStack Footer module class.
	*/
	class StacheStack_Footer {

		function __construct() {
			add_action( 'wp_enqueue_scripts',    array( $this, 'css' ), 101 );
			add_action( 'stachestack_footer_html', array( $this, 'html' ) );
		...
		function widgets_init() {
			...
			register_sidebar( array(
				'name'          => __( 'Footer Widget Area 1', 'stachestack' ),
				'id'            => 'sidebar-footer-1',
				'before_widget' => '<section id="%1$s" class="' . $class . ' widget %2$s">',
				'after_widget'  => '</section>',
				'before_title'  => $before_title,
			...
			register_sidebar( array(
				'name'          => __( 'Footer Widget Area 2', 'stachestack' ),
				'id'            => 'sidebar-footer-2',
				'before_widget' => '<section id="%1$s" class="' . $class . ' widget %2$s">',
				'after_widget'  => '</section>',
				'before_title'  => $before_title,
			...
			register_sidebar( array(
				'name'          => __( 'Footer Widget Area 3', 'stachestack' ),
				'id'            => 'sidebar-footer-3',
				'before_widget' => '<section id="%1$s" class="' . $class . ' widget %2$s">',
				'after_widget'  => '</section>',
				'before_title'  => $before_title,
			...
			register_sidebar( array(
				'name'          => __( 'Footer Widget Area 4', 'stachestack' ),
				'id'            => 'sidebar-footer-4',
				'before_widget' => '<section id="%1$s" class="' . $class . ' widget %2$s">',
				'after_widget'  => '</section>',
				'before_title'  => $before_title,
		...
		function html() {
			...
			do_action( 'stachestack_footer_before_copyright' );
