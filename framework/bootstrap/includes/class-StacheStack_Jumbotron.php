...
if ( ! class_exists( 'StacheStack_Jumbotron' ) ) {

	/**
	* The Jumbotron module
	*/
	class StacheStack_Jumbotron {

		function __construct() {
			add_action( 'widgets_init',       array( $this, 'jumbotron_widgets_init'           ), 20  );
			add_action( 'stachestack_pre_wrap', array( $this, 'jumbotron_content'                ), 5   );
